...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--players", default="Stephen Curry,Nikola Jokic", help="Comma-separated player names or ids")
    parser.add_argument("--games", default="Golden State Warriors,Denver Nuggets", help="Comma-separated team names or game ids")
