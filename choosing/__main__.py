...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--players", default="", help="Comma-separated player names or ids")
    parser.add_argument("--games", default="", help="Comma-separated team names or game ids")
