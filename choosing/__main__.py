...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--players", default="Jayson Tatum,Nikola Jokic", help="Comma-separated player names or ids")
    parser.add_argument("--games", default="Boston Celtics,Denver Nuggets", help="Comma-separated team names or game ids")
