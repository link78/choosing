...
class PredictionApiTests(unittest.TestCase):
    ...
    def test_root_endpoint_describes_application(self):
        ...
        self.assertNotIn("Available API", response["raw_body"])
        self.assertNotIn("The Odds API endpoints", response["raw_body"])
        self.assertNotIn("The Odds API sports", response["raw_body"])
        self.assertIn("Coverage", response["raw_body"])
        self.assertIn("Players tracked", response["raw_body"])
        self.assertIn("Teams tracked", response["raw_body"])
